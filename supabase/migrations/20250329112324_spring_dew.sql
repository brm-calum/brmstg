/*
  # Fix HTTP Function Error

  1. Changes
    - Creates http extension if it doesn't exist
    - Updates send_email function to use proper HTTP handling
...
-- Update send_email function to use proper HTTP handling
...
BEGIN
  ...
  BEGIN
    ...
    IF v_response->>'Status' != 'success' THEN
      RAISE EXCEPTION 'Mailjet API error: %', v_response;
    END IF;
