/*
  # Add HTTP Request Type and Update Send Email Function

  1. Changes
    - Creates http_request type if it doesn't exist
...
-- Add comments
COMMENT ON TYPE http_request IS 'Type for making HTTP requests';
