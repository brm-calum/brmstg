/*
  # Fix get_booking_details function

  1. Changes
    - Updates get_booking_details to properly handle permissions
...
BEGIN
  RETURN (
    ...
    AND (
      b.trader_id = auth.uid()  -- User is trader
      OR b.warehouse_owner_id = auth.uid()  -- User is warehouse owner
...
-- Add comments
COMMENT ON FUNCTION get_booking_details IS 'Gets detailed booking information with proper permission checks';