/*
  ...
  1. Changes
    - Adds inquiry start_date and end_date to response
...
-- Add comments
COMMENT ON FUNCTION get_booking_offers IS 'Gets all offers for an inquiry with complete space, service, fee details and inquiry dates';