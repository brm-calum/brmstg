-- Update get_user_inquiries function to include warehouse owner inquiries
...
BEGIN
  ...
  WHERE i.user_id = auth.uid()  -- User is the inquirer
    OR w.owner_id = auth.uid()  -- User is the warehouse owner
    OR EXISTS (                 -- User is involved in responses
