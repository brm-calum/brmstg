...
export function InquiryForm({ initialData, onSubmit, onCancel, onWarehouseChange }: InquiryFormProps) {
      ...
      <form onSubmit={handleSubmit} className="p-6">
        ...
        <div className="space-y-6">
          ...
          <SpaceRequestForm
            ...
            selectedWarehouseIds={formData.warehouse_ids}
          ...
          {/* Estimated Cost */}
          {estimatedCost !== null && formData.warehouse_ids.length === 1 && (
          ...
          {formData.warehouse_ids.length > 1 && (
            <div className="p-4 bg-blue-50 rounded-lg">
              <p className="text-sm text-blue-700">
                Estimated cost is not available when multiple warehouses are selected. You will receive separate offers for each warehouse.
              </p>
            </div>
          )}
